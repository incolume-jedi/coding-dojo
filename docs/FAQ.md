...
Foi separado alguns [sites populares com desafios de programação](coding_challenge/README.md), como também a nova tendencia do momento [desenvolvimento em Inteligência Artificial](coding_ia/README.md) e muitos destes desafios serão resolvidos em grupo nos encontros da guilda jedi incolume.
