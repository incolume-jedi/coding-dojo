...
**Unificar todas as soluções para validação de números primos**

Unificar todas as soluções para validação de números primos encontradas no dojo.
